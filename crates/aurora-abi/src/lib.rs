...
macro_rules! for_each_builtin {
    ($m:ident) => {
        ...
        [scalar,   net_set_world_len,             aurora_net_set_world_len,              [I64],                                           void]
        [scalar,   net_set_world,                 aurora_net_set_world,                  [I64, F64],                                      void]
        [scalar,   net_world_len,                 aurora_net_world_len,                  [],                                              I64]
        [scalar,   net_world,                     aurora_net_world,                      [I64],                                           F64]
        [scalar,   net_world_gen,                 aurora_net_world_gen,                  [],                                              I64]
