...
macro_rules! for_each_builtin {
    ($m:ident) => {
        ...
        [scalar,   tick_alpha,                    aurora_tick_alpha,                     [],                                              F64]
        ...
        [scalar,   phys_remove,                   aurora_phys_remove,                    [I64],                                           I64]
        [scalar,   phys_alive,                    aurora_phys_alive,                     [I64],                                           I64]
        ...
        [scalar,   r3d_draw_scaled,               aurora_r3d_draw_scaled,                [I64, F64, F64, F64, F64, F64, F64, F64, F64, F64], void]
        ...
        [scalar,   r3d_anim_seek,                 aurora_r3d_anim_seek,                  [I64, F64],                                      void]
        ...
        [text,     r3d_clip_name,                 aurora_r3d_clip_name,                  [I64, I64],                                      Str]
        [text,     r3d_clip_index,                aurora_r3d_clip_index,                 [I64, Ptr, I64],                                 I64]
        [text,     r3d_joint_index,               aurora_r3d_joint_index,                [I64, Ptr, I64],                                 I64]
        [text,     r3d_joint_name,                aurora_r3d_joint_name,                 [I64, I64],                                      Str]
        [scalar,   r3d_show_joints,               aurora_r3d_show_joints,                [I64],                                           void]
        ...
        [scalar,   phys3d_spherecast,             aurora_phys3d_spherecast,              [F64, F64, F64, F64, F64, F64, F64, F64, I64],   F64]
        ...
        [scalar,   net_player_input,              aurora_net_player_input,               [I64, I64],                                      F64]
        [scalar,   net_set_local_state,           aurora_net_set_local_state,            [I64, F64],                                      void]
        [scalar,   net_owned_movement,            aurora_net_owned_movement,             [I64],                                           void]
        [scalar,   net_set_world_len,             aurora_net_set_world_len,              [I64, I64],                                      void]
        [scalar,   net_set_world,                 aurora_net_set_world,                  [I64, I64, F64],                                 void]
        [scalar,   net_world_len,                 aurora_net_world_len,                  [I64],                                           I64]
        [scalar,   net_world,                     aurora_net_world,                      [I64, I64],                                      F64]
        [scalar,   net_world_gen,                 aurora_net_world_gen,                  [I64],                                           I64]
        ...
        [scalar,   net_set_object_size,           aurora_net_set_object_size,            [I64, F64, F64],                                 void]
        [scalar,   net_set_object_state,          aurora_net_set_object_state,           [I64, I64, F64],                                 void]
        [scalar,   net_object_state,              aurora_net_object_state,               [I64, I64],                                      F64]
        ...
        [scalar,   input_pressed,                 aurora_input_pressed,                  [I64],                                           I64]
        [scalar,   input_released,                aurora_input_released,                 [I64],                                           I64]
        [scalar,   input_step,                    aurora_input_step,                     [],                                              void]
