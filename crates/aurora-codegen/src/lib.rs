...
const BUILTINS: &[&str] = &[
    ...
    "r3d_anim_play", "r3d_anim_update", "r3d_anim_play_upper", "r3d_anim_aim_upper", "r3d_anim_blend", "r3d_pose_bone", "r3d_clear_pose", "r3d_anim_stop_upper", "r3d_clip_count", "r3d_present",
